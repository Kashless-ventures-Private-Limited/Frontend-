        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight text-[#0B1E3D] leading-tight">
              Less friction in day-to-day technology operations.
            </h1>
            <p className="mt-6 text-lg sm:text-xl text-[#475569] leading-relaxed">
              We help organisations navigate licensing decisions and establish ongoing technology support around the priorities that matter most.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="max-w-2xl mx-auto space-y-6">
            ...
            <p className="text-slate-600 text-lg">
              Let’s discuss an ongoing support and licensing framework tailored to your business priorities.
            </p>
            <div className="pt-2">
              <Link
                href="/contact"
              ...
              >
                <span>Discuss ongoing technology support</span>
