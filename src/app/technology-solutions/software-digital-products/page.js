...
import { ArrowRight, CheckCircle2, Cpu, ArrowLeft, ShieldCheck } from "lucide-react";
import {createSeoMetadata } from "@/lib/data";

export const metadata = createSeoMetadata("softwareDigitalProducts", "/technology-solutions/software-digital-products");
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight text-[#0B1E3D] leading-tight">
              Software that supports the way your business needs to work.
            </h1>
            <p className="mt-6 text-lg sm:text-xl text-[#475569] leading-relaxed">
              We help turn operating needs into practical digital solutions - from workflow and application thinking to implementation-ready product direction.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="max-w-2xl mx-auto space-y-6">
            <h2 className="text-3xl font-bold text-[#0B1E3D]">
              Ready to shape your digital solution?
            </h2>
            <p className="text-slate-600 text-lg">
              Let’s explore how software and workflow design can make your operations more productive.
            </p>
            <div className="pt-2">
              <Link
                href="/contact"
              ...
              >
                <span>Discuss your software needs</span>
