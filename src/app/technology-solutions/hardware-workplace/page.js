        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded bg-[#0B1E3D] text-white text-xs font-semibold uppercase tracking-wider mb-4">
              <Laptop className="w-3.5 h-3.5 text-[#0D9488]" />
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight text-[#0B1E3D] leading-tight">
              Workplace technology that keeps people connected and productive.
            </h1>
            <p className="mt-6 text-lg sm:text-xl text-[#475569] leading-relaxed">
              Devices, collaboration tools and workplace infrastructure work best when they are selected around real work patterns - not just specifications.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="max-w-2xl mx-auto space-y-6">
            ...
            <p className="text-slate-600 text-lg">
              Explore dependable device procurement, collaboration setups, and hybrid-work technology.
            </p>
            <div className="pt-2">
              <Link
                href="/contact"
              ...
              >
                <span>Talk about your workplace technology</span>
