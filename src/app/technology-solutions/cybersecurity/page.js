        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight text-[#0B1E3D] leading-tight">
              Security that supports confident business.
            </h1>
            <p className="mt-6 text-lg sm:text-xl text-[#475569] leading-relaxed">
              Security needs to be relevant to how your organisation works. We help focus attention on the safeguards, visibility and practices that support a more resilient operation.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="max-w-2xl mx-auto space-y-6">
            <h2 className="text-3xl font-bold text-[#0B1E3D]">
              Protect your operations with clarity
            </h2>
            <p className="text-slate-600 text-lg">
              Discuss your current risk profile, security posture, and readiness roadmap with our team.
            </p>
            <div className="pt-2">
              <Link
                href="/contact"
