export const siteConfig = {
  ...
  tagline: "Engineering Possibilities. Investing in Potential.",
  positioning:
...
export const techSolutionsList = [
  ...
  },
  {
    ...
    headline: "Infrastructure planned for continuity, performance and change.",
    cardCopy:
...
export const howWeWork = [
  { step: "Understand", description: "Listen, clarify the challenge and understand the business context." },
  { step: "Plan", description: "Define priorities, requirements and a practical path forward." },
  { step: "Build", description: "Develop, configure or implement the agreed solution." },
  { step: "Secure", description: "Address security, data protection and operational risk." },
  { step: "Deploy", description: "Put the solution into operation with the right people and process." },
  { step: "Support", description: "Maintain, monitor and improve the solution as needs evolve." },
  { step: "Scale", description: "Extend capabilities as the business grows and priorities change." },
];

export const consultationServices = [
  {
    title: "Business Process Improvement",
    description: "Review existing processes, identify inefficiencies and create practical improvement opportunities.",
  },
  {
    title: "Technology & Digital Strategy",
    description: "Connect business objectives with practical technology choices, priorities and implementation plans.",
  },
  {
    title: "Workflow & SOP Design",
    description: "Structure workflows, documentation and standard operating procedures to create consistency and improve execution.",
  },
  {
    title: "Operational Planning",
    description: "Translate business requirements into clear plans, responsibilities, timelines and execution priorities.",
  },
  {
    title: "Growth & Opportunity Assessment",
    description: "Evaluate business challenges and opportunities to identify realistic areas for improvement, expansion or collaboration.",
  },
  {
    title: "Implementation Support",
    description: "Stay involved beyond recommendations by helping teams coordinate actions, track progress and move from plan to execution.",
  },
];

export const valuesList = [
  { title: "Clarity", description: "We believe good decisions start with understanding the real problem." },
  { title: "Practicality", description: "We focus on solutions that can be implemented and used in the real world." },
  { title: "Collaboration", description: "We bring the right people and capabilities together around shared outcomes." },
  { title: "Integrity", description: "We communicate clearly and approach execution responsibly." },
  { title: "Continuous Learning", description: "We keep improving our understanding, methods and capabilities." },
  { title: "Long-Term Value", description: "We build relationships and solutions with durable outcomes in mind." },
];
...
export const enquiryRoutes = [
  {
    ...
    intro: "Tell us about the technology challenge, current environment and outcome you are working toward.",
    placeholderMessage: "Describe your technology environment, priorities or the challenge you are looking to address...",
  },
  {
    id: "consultation",
    name: "Business Consultation",
    intro: "Tell us about the business challenge, process or decision where you need practical support.",
    placeholderMessage: "Describe the business challenge, process or decision you would like to discuss...",
  },
  {
    id: "partnerships",
    name: "Strategic Partnership",
    intro: "Tell us who you are, what you do and where you see a potential collaboration.",
    placeholderMessage: "Share your capabilities and the kind of collaboration you would like to explore...",
  },
  {
    id: "general",
    name: "General Business Enquiry",
    intro: "For all other questions, send us a message and we will direct it appropriately.",
...
export const seoMetadataMap = {
  ...
  privacyPolicy: {
    ...
    description: "Privacy practices for the Kashless Ventures website.",
  },
  terms: {
    title: "Terms of Use | Kashless Ventures",
    description: "Terms governing use of the Kashless Ventures website.",
  },
  cookiePolicy: {
    title: "Cookie Notice | Kashless Ventures",
    description: "Cookie and privacy information for the Kashless Ventures website.",
  },
};
